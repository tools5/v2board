            ...
            if (strpos($request->header('user-agent'), 'Win64') !== false) {
                return response([
                    'data' => [
                        ...
                        'download_url' => ConfiguredUrl::normalizeExternalHttpUrl(config('v2board.windows_download_url'))
                    ]
                ]);
            } else {
                return response([
                    'data' => [
                        ...
                        'download_url' => ConfiguredUrl::normalizeExternalHttpUrl(config('v2board.macos_download_url'))
                    ]
                ]);
            }
            return;
