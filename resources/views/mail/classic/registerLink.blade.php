                ...
                <div style="background:#fff">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr style="padding:40px 40px 0 40px;display:table-cell">
                            <td style="font-size:24px;line-height:1.5;color:#000;margin-top:40px">验证您的电子邮箱地址</td>
                        </tr>
                        <tr>
                            <td style="font-size:14px;color:#333;padding:24px 40px 0 40px">
                                ...
                                <br />
                                <br />
                                您正在注册 {{$name}}。请在 {{$expire_minutes}} 分钟内点击下方按钮设置密码并完成注册。若非本人操作，请忽略本邮件。
                                <br />
                                <br />
                                <a href="{{$link}}" style="display:inline-block;background:#415A94;color:#fff;padding:10px 18px;border-radius:4px;text-decoration:none;">完成注册</a>
                                <br />
                                <br />
